...
//        add_filter( 'cron_schedules', array( __CLASS__, 'cron_schedules' ) );
    ...
    public static function install() {
        ...
        if ( 'yes' === get_transient( '{%= function_prefix %}s_installing' ) ) {
            return;
        }
    ...
    public static function create_options() {
        ...
        //save install date
        update_option( '{%= function_prefix %}s_install_date', current_time( 'timestamp' ) );
    }
    ...
    public static function cron_schedules( $schedules ) {
        $schedules['monthly'] = array(
            'interval' => 2635200,
            'display'  => __( 'Monthly', '{%= text_domain %}' ),
        );
    ...
    private static function create_cron_jobs() {
        wp_clear_scheduled_hook( '{%= function_prefix %}_daily_cron' );
        wp_schedule_event( time(), 'daily', '{%= function_prefix %}_daily_cron' );
    }
